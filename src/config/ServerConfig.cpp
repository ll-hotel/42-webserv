...
const std::string& ServerConfig::server_name() const
{
	return _server_name;
}
...
const std::string& ServerConfig::index_page() const
{
	return _index_page;
}
...
const size_t ServerConfig::body_size() const
{
	return _body_size;
}
const int ServerConfig::port() const
{
	return _port;
}
...
const bool ServerConfig::do_post() const
{
	return _methods.at("POST");
}
const bool ServerConfig::do_get() const
{
	return _methods.at("GET");
}
const bool ServerConfig::do_upload() const
{
	return !_upload_dir.empty();
}
const std::string& ServerConfig::upload_dir() const
{
	return _upload_dir;
}
